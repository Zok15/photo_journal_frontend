...
const en = {
  ...
  'Добавление: новые': 'Added: newest',
  'Добавление: старые': 'Added: oldest',
  'Съёмка: новые': 'Taken: newest',
  'Съёмка: старые': 'Taken: oldest',
  'Новые': 'Newest',
  'Старые': 'Oldest',
