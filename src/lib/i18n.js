...
const en = {
  ...
  'Опубликовать (админ)': 'Publish (admin)',
  'Серия опубликована админом.': 'Series published by admin.',
  'Не удалось опубликовать серию.': 'Failed to publish series.',
